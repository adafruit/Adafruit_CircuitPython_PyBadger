...
pybadger.badge_line(text="Blinka", color=pybadger.WHITE, scale=3, padding_above=1)
pybadger.badge_line(text="CircuitPython", color=pybadger.WHITE, scale=2, padding_above=1)
