...
htmlhelp_basename = 'AdafruitPybadgerLibrarydoc'
...
latex_documents = [
    (master_doc, 'AdafruitPyBadgerLibrary.tex', u'AdafruitPyBadger Library Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'AdafruitPyBadgerlibrary', u'Adafruit PyBadger Library Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AdafruitPyBadgerLibrary', u'Adafruit PyBadger Library Documentation',
     author, 'AdafruitPyBadgerLibrary', 'One line description of project.',
     'Miscellaneous'),
]
